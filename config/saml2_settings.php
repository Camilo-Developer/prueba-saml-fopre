...
return $settings = array(
     ...
     * If commented out, defaults to this lib's controller (Aacotroneo\Saml2\Http\Controllers\SamlController).
     * If you need to extend SamlController (e.g. to override the `login()` function to pass
