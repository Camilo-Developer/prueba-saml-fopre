...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Lista de Pedidos anticipados Entregados</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Lista de Pedidos anticipados Entregadoss</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('admin.preorders.index')}}" class=" btn-preorders-entregadas btn btn-danger btn-sm">Pendientes</a>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                <form method="post" action="{{route('admin.preorders.destroy', $preorder)}}" id="eliminarpreorder_{{ $loop->iteration }}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                ...
                                                <a title="Editar" href="{{route('admin.preorders.edit',$preorder)}}"
